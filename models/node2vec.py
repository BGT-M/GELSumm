...
def node2vec(graph, seed=42):
    ...
    model = Word2Vec(walks, size=args.embed_dim, window=args.window_size, min_count=0, sg=1, seed=seed, workers=args.workers, iter=args.iter)
